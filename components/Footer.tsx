        ...
        <div className="text-center space-y-6">
          ...
          <div className="glass-effect rounded-2xl p-6 mx-auto max-w-2xl border border-cyan-500/20">
            ...
            <p className="mt-2 text-base">
              Site feito por <a href="https://cth.jp/" target="_blank" rel="noopener noreferrer" className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 font-bold hover:opacity-80 transition-opacity">cth.jp</a>
            </p>
          </div>
