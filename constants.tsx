...
export const MikuOutlineIcon = ({ className }: { className?: string }) => ( // More Miku-like icon
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM12 12v.01M7.5 16.5h9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75H7.5a3 3 0 00-3 3V9m10.5-5.25H16.5a3 3 0 013 3V9"/>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75C7.5 2.404 8.574 1.5 9.75 1.5s2.25.904 2.25 2.25v0"/>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75c0-1.346-1.074-2.25-2.25-2.25S12 2.404 12 3.75v0"/>
  </svg>
);
...
export const NAV_LINKS: PageRoute[] = [
  ...
  { path: '/sobre-miku', name: 'Sobre a Miku', component: SobreMikuPage, icon: MikuOutlineIcon },
...
export const MIKU_TEAL = '#00AEEF'; // A common Miku teal/blue
export const MIKU_PINK = '#FF69B4'; // A common Miku pink/magenta

export const SITE_TITLE = "Hatsune Miku Fan Hub";
